...
public class EditarRecetaWindow extends TransactionalDialog<EditarRecetasModel> {
  public EditarRecetaWindow(final WindowOwner owner, final Receta receta) {
  ...
  protected void createFormPanel(final Panel mainPanel) {
    ...
    final Procedure1<Button> _function_5 = new Procedure1<Button>() {
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            EditarRecetaWindow.this.getModelObject().agregar();
          }
        };
    ...
    final Procedure1<Button> _function_6 = new Procedure1<Button>() {
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            EditarRecetaWindow.this.getModelObject().eliminar();
          }
        };
        it.onClick(_function);
      }
  ...
  protected void addActions(final Panel actionsPanel) {
    ...
    final Procedure1<Button> _function = new Procedure1<Button>() {
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            EditarRecetaWindow.this.accept();
          }
        };
        it.onClick(_function);
      }
